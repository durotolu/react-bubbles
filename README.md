...
A token is used for authentication to a network service
...
A web server hosts web pages and interact with other computers to upload these pages on request
